    ...
    <div className="bg-white">
      ...
      <div className="max-w-[700px] mx-auto">
        <div id="editor-container" className="flex w-full">
          <div id="canvas-container" className="w-full max-w-[410px] mx-auto">
            <Navbar />
          ...
          <div className="relative">
            <button
              className={`sm:hidden bg-yellow-300 hover:bg-yellow-200 shadow-[5px_5px] fixed w-12 h-20 border border-black top-0 ${
            ...
            <div
              className={`color-picker bg-white fixed h-full top-0 right-0 sm:relative ${
                drawerOpen
