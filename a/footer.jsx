...
export default function Footer() {
  return (
    <div className="text-xs py-4 flex flex-col items-center justify-center">
      ...
      <a
        target="_blank"
        rel="noopener noreferrer"
        className="text-zinc-700 hover:text-zinc-700/60"
      ...
      <a
        target="_blank"
        rel="noopener noreferrer"
        className="text-violet-600 hover:text-violet-600/60"
